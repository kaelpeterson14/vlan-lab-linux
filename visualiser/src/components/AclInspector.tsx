...
export default function AclInspector() {
    ...
    return (
        <div className="w-80 h-full overflow-y-auto border-l border-gray-800 bg-gray-950 p-4 font-mono">
            <h2 className="text-white text-sm font-bold mb-4">ACL Rules — FORWARD Chain</h2>
            <div className="flex flex-col gap-3">
                {aclRules.map(rule => (
                    <div
                        key={rule.id}
                        className={`border rounded p-3 text-xs transition-colors ${lastMatchedRule?.id === rule.id
                ...
                <div className="border border-red-900 rounded p-3 text-xs bg-gray-900">
